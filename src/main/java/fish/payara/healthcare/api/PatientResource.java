...
public class PatientResource {
    ...
    public Response updatePatient(
            ...
            @Valid @NotNull Patient patientData) {
        ...
        return patientRepository.findById(patientId)
                .map(existingPatient -> {
                    ...
                    existingPatient.setSsn(patientData.getSsn());
                    ...
                    existingPatient.setMedicalConditions(patientData.getMedicalConditions());
                    existingPatient.setAssignedDoctor(patientData.getAssignedDoctor());
                    existingPatient.setDepartment(patientData.getDepartment());
